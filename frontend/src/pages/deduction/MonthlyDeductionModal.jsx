...
import { updateMonthlyDeduction, createMonthlyDeduction } from '../../features/monthlyDeductionSlice';
...
const MonthlyDeductionModal = ({ show, handleClose, data, types, deductions }) => {
	...
	const handleSubmit = (e) => {
        ...
        if(formData.id) {
            dispatch(updateMonthlyDeduction({ id: formData.id, data: payload }));
        } else {
            dispatch(createMonthlyDeduction(payload));
        }
	};
	...
	return (
		<Modal size="xl" show={show} onHide={handleClose} >
			<Modal.Header closeButton>
				<Modal.Title>Monthly Deduction</Modal.Title>
			</Modal.Header>
			<Modal.Body>
...
export default MonthlyDeductionModal;