...
const NightAllowance = () => {
    ...
    const [nightAllowanceData, setNightAllowanceData] = useState([]);
    ...
    const handleSubmit = () => {
        ...
        setNightAllowanceData([...nightAllowanceData, newEntry]);
        // Clear form fields
        setEmpId("");
        setEmpName("");
        setDesignation("");
    ...
    const columns = [
        ...
        { name: "Night Worked", selector: (row) => row.daysWorked, sortable: true },
        { name: "Rate Per Day", selector: (row) => row.ratePerDay, sortable: true },
        { name: "Amount", selector: (row) => row.amount, sortable: true },
    ];

    return (
        <div className="night-allowance">
